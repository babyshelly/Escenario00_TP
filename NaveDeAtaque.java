...
public class NaveDeAtaque extends NaveAliada implements Atacante {
    ...
    public ContenedorDeRecursos obtenerContenedorEnPosicion() {
        return (ContenedorDeRecursos) getOneObjectAtOffset(0, 0, ContenedorDeRecursos.class);
    }
    
    public boolean motoresEncendidos() {
        return this.motoresEncendidos;
    }
}
